...
from rag.advanced_rag.keyword_agentic_graph_v7 import run_keyword_agentic_rag_v7
...
class RAGTools:
    ...
    async def _rag_once(self, question: str) -> str:
        ...
        final = ""
        async for kind, delta in _split_think_stream(run_keyword_agentic_rag_v7(self, messages)):
            if kind == "answer":
                final += delta
